                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        for mention in mentionees:
                            if mention["M"] not in lists:
                                lists.append(mention["M"])
                        for ls in lists:
                            path = "http://dl.profile.Galank.naver.jp/" + Kia.getContact(ls).pictureStatus + "/vp"
                            Kia.sendImageWithURL(msg.to, str(path))
                        ...
                        for mention in mentionees:
                            if KiaMID in mention["M"]:
                              if settings["detectMention"] == True:
                                ...
                                Kia.sendMessage(to, "──┅━✥ ʀᴇsᴘᴏɴ ✥━┅── \n ᴍᴀᴀғ ᴋᴋ ᴀᴋᴜ ᴍᴀsɪʜ sɪʙᴜᴋ \n ᴊɪᴋᴀ ᴘᴇɴᴛɪɴɢ sɪʟᴀʜᴋᴀɴ ᴘᴄ sᴀᴊᴀ.\n ──┅━✥ ======= ✥━┅──") 
...
#=============Tambahan===============
               ...
               Kia.sendContact(to, "'xxx")
               Kia.sendText(to,"JANGAN MASUK GRUP INI KALO GAK KUAT")
#=============================
        if op.type == 55:
